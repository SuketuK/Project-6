#Created 2/1/2017 by Chris Peterson, Suketu Kothari
#Verion : 0.95 release candidate 1.
#place this and the credentials.yml file in the same location.
import pandas as pd
import psycopg2
import yaml
...
def select_pages_vector ( page_ids = [], location = 'remote'):
	"""
	This function will return pages the have a pagid in the list 'page_ids'.  
	Set the location string to select the database to be used.
	"""
